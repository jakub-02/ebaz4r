...
public class KategoriaOblecenie extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Oblečenie");
    ...
    protected void onStart()
    {
        ...
        Query query = ProductsRef.orderByChild("kategoria").equalTo("Oblečenie");
        ...
        FirebaseRecyclerAdapter<ProductDetail, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<ProductDetail, ProductViewHolder>(options) {
                    ...
                    {
                        if(model.getKategoria().equals("Oblečenie")){
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case (R.id.nav_home):{
                Intent intent = new Intent(KategoriaOblecenie.this, MenuActivity.class);
                startActivity(intent);
                break;
            }

            case (R.id.nav_categories):{
                Intent intent = new Intent(KategoriaOblecenie.this, CategoriesActivity.class);
                startActivity(intent);
                break;
            }

            case (R.id.nav_profile): {
                Intent intent = new Intent(KategoriaOblecenie.this, ProfileActivity.class);
                startActivity(intent);
                break;
            }

            case (R.id.nav_logout): {
                Intent intent = new Intent(KategoriaOblecenie.this, MainActivity.class);
                startActivity(intent);
                Toast.makeText(KategoriaOblecenie.this, "Odhlásenie bolo úspešné.", Toast.LENGTH_SHORT).show();
                break;
            }
        }
