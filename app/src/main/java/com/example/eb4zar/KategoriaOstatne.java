...
public class KategoriaOstatne extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ostatné");
    ...
    protected void onStart()
    {
        ...
        Query query = ProductsRef.orderByChild("kategoria").equalTo("Ostatné");
        ...
        FirebaseRecyclerAdapter<ProductDetail, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<ProductDetail, ProductViewHolder>(options) {
                    ...
                    {
                        if(model.getKategoria().equals("Ostatné")){
                            ...
                            holder.itemView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent i = new Intent(KategoriaOstatne.this, ProductDetailActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case (R.id.nav_home):{
                Intent intent = new Intent(KategoriaOstatne.this, MenuActivity.class);
                startActivity(intent);
                break;
            }

            case (R.id.nav_categories):{
                Intent intent = new Intent(KategoriaOstatne.this, CategoriesActivity.class);
                startActivity(intent);
                break;
            }

            case (R.id.nav_profile): {
                Intent intent = new Intent(KategoriaOstatne.this, ProfileActivity.class);
                startActivity(intent);
                break;
            }

            case (R.id.nav_logout): {
                Intent intent = new Intent(KategoriaOstatne.this, MainActivity.class);
                startActivity(intent);
                Toast.makeText(KategoriaOstatne.this, "Odhlásenie bolo úspešné.", Toast.LENGTH_SHORT).show();
                break;
            }
        }
